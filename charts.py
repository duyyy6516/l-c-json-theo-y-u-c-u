...
def draw_vpd_chart(df, vpd_min, vpd_max):
    # GIẢI PHÁP ĐỔ MÀU TRÀN VIỀN 100% CỦA BẠN ĐÃ ĐƯỢC ĐÓNG GÓI TẠI ĐÂY
    ...
    return (rect_blue + rect_red + line_vpd).properties(height=260)
...
def draw_combined_chart(df):
    ...
    return alt.layer(weather_layer, line_v).properties(height=260).resolve_scale(y='independent').interactive()
